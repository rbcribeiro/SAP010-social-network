...
const updateProfileImageURL = async (imagePath) => {
  try {
    const userId = getUserId();
    const userRef = gh(db$1, "users", userId);
    await gf(userRef, {
...
const timeline = () => {
    ...
    <div class="container">
      <div class='left-timeline'>
        ...
        <label for="profilePhotoUpload" class="photo-timeline">
          <img src="./assets/icon-photo.png" id="profileImagePreview" class="photo-timeline" alt="Icone photo"> 
        </label>
  ...
  const profilePhotoUploadInput = timeline2.querySelector("#profilePhotoUpload");
  const profileImagePreview = timeline2.querySelector("#profileImagePreview");
  const createPostElement = (name2, createdAt, description, postId, authorId) => {
      ...
      <div class="post-container">
        ...
        <div class='image-icons'>
          ...
          <button type="button" class='icons' id='editPost'>
            <a class='icons' id='editPost'><img src='./assets/editicon.png' alt='edit image' width='30px'></a>
          </button>
  ...
  const loadPosts = async () => {
    ...
    postsFirestore.forEach((post) => {
      ...
      const postElement = createPostElement(name2, createdAt, description, id2, author);
  ...
  const handleProfilePhotoUploadChange = () => {
    ...
    if (file) {
      uploadProfileImage(file).then((imagePath) => {
        updateProfileImageURL(imagePath).then(() => {
